<?php
    ...
    //Conncetion to the mongodb database.
    ...
    //Clears variables if Cancel button is pressed - Empties the inputs.
...
<body>
    <div id="Header" class="Header">
        <img src="IMG\CodeInfinityLogo.jpg">
        <h2 id="Main_title">Submition to database</h2>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
        ...
        <input type="text" id="Name" name="fName" placeholder="John" value="<?php echo $name; ?>">
        
        <label for="sName">Surname</label>
        <input type="text" id="Surname" name="sName" placeholder="Doe" value="<?php echo $surname; ?>">
        
        <label for="IDNum">ID Number</label>
        <input type="text" id="ID" name="IDNum" placeholder="0101235122123" value="<?php echo $ID; ?>">
